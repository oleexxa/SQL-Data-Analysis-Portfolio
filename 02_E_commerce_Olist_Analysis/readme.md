...
* **At-Risk High-Value:** Detected 468 premium customers (lifetime spend > 1,000 units) who show early signs of churn, representing a critical win-back opportunity.
...
* **Operational Benchmark:** São Paulo (SP) remains the logistical leader, handling the highest volume of orders with the most efficient performance.
...
## 📊 Data Source
**Brazilian E-Commerce Public Dataset by Olist** 🔗 [Kaggle Dataset](https://
